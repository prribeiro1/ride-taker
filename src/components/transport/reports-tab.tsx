...
import { getMonthlyReport } from "@/lib/storage";
              ...
              {reportData.map((item) => (
                ...
                >
                  <div className="flex-1">
                    <h4 className="font-medium">{item.child.name}</h4>
                  ...
                  <div className="flex items-center gap-4 text-sm">
                    <div className="text-center">
                      <div className="font-bold text-success">{item.present}</div>
                      <div className="text-xs text-muted-foreground">Presente</div>
                    </div>
                    <div className="text-center">
                      <div className="font-bold text-destructive">{item.absent}</div>
